  ...
  return (
    <div className="max-w-xl mx-auto p-8 bg-black/70 rounded-xl text-white flex flex-col gap-4">
      ...
      <input
        ...
        className="p-2 bg-gray-900 text-white placeholder-gray-400 border border-gray-700 rounded focus:outline-none focus:border-blue-500"
      />
      ...
      <div className="relative group w-full">
        <input
          ...
          disabled={!!user}
          title={user ? "Email-ul este preluat din contul tău și nu poate fi modificat." : ""}
        ...
        {user && (
          <span className="absolute left-0 bottom-full mb-1 w-max rounded bg-gray-900 text-gray-300 text-xs p-1 shadow-lg
            opacity-0 translate-y-1 group-hover:opacity-100 group-hover:translate-y-0
            transition-all duration-200 ease-out pointer-events-none">
            Email-ul este preluat din contul tău și nu poate fi modificat.
          </span>
        )}
      </div>
