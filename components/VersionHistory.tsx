...
export default function Footer() {
  ...
  return (
    <>
      <footer className="bg-gray-900 text-gray-300 p-4 text-center cursor-pointer hover:text-white"
        ...
        <div className="fixed inset-0 bg-black/50 flex justify-center items-center z-50">
          <div className="bg-gray-800 text-white rounded-lg max-w-lg w-full max-h-[80vh] overflow-auto p-6 relative">
            ...
            <button
              ...
              className="absolute top-2 right-2 text-gray-300 hover:text-white font-bold"
            >
              ✕
            </button>
          </div>
